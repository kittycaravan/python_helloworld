"""
    유저가 건강과 관련된 행위를 한 것을 한 문장으로 입력하면 				
	이 행동이 건강에 + 인지 - 인지를 판단하는 AI				
			데이터(0/1)		
	학습	ex.	0	밥 먹고 바로 잠	
			1	퇴근하고 30분거리 걸어서 집에 왔음	
			0	퇴근은 항상 자가용으로 함	
			0	오늘 회식 함	
	확장	일기를 쓰면 그 내용으로 위 판단.			
"""
...
# test_sentence = "밤늦게 야식을 가끔 먹는편입니다."
test_sentence = "매운걸 좋아함"
